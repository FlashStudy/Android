...
public class FlashcardDeleteAdapter extends BaseAdapter {
    private Activity activity;
    private Context mContext;
    private List<FlashcardOff> flashcardOffs;
    private List<Boolean> selecionados = new ArrayList<>();

    public FlashcardDeleteAdapter(Activity a, Context context, List<FlashcardOff> flashcardOffs) {
        activity = a;
        mContext = context;
        this.flashcardOffs = flashcardOffs;

    }

    public int getCount() {
        // TODO Auto-generated method stub
        return flashcardOffs.size();
    }

    public Object getItem(int arg0) {
        // TODO Auto-generated method stub
        return flashcardOffs.get(arg0);
    }

    public long getItemId(int position) {
        // TODO Auto-generated method stub
        return flashcardOffs.get(position).getCodigo();
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        nome.setText(flashcardOffs.get(position).getTitulo());
        return vi;
    }
}
